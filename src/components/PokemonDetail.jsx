  ...
  return (
    ...
    >
      <div className='pt-5 '>
        ...
        <h1 className='font-head font-semibold text-4xl md:text-6xl text-white text-center relative top-20 right-0 2xl:top-1 2xl:text-lg
                2xl:right-[45rem]'
        >{name.toUpperCase()}
        </h1>
        <span className='font-head text-4xl text-white relative left-8  bottom-8 '>#{pokemon?.id}</span>
      </div>
      <img
        className='w-72  2xl:w-[33rem] 2xl:top-[1rem] md:w-[22rem]  relative left-14 md:mx-40  lg:mx-[18rem] xl:left-[12rem] xl:top-[2rem]
            2xl:left-[10rem]   top-20 md:top-1 z-10' src={pokemon?.sprites.other.home.front_default} alt=''
      />
      ...
      }
      {
        ...
        <div className=' relative mr-10 md:relative md:top-1 md:mx-[7rem] lg:right-[20rem]  2xl:flex   2xl:top-40 2xl:left-[1rem] 2xl:border-l '>
          <div className='font-mono 2xl:whitespace-nowrap font-bold text-xl  top-40 2xl:top-[10.8rem] py-3 px-4 mt-3 bg-white rounded-xl ml-5 opacity-75 w-52
                    lg:w-[23rem] lg:right-20 2xl:w-[7rem]  2xl:text-sm  text-center h-12'>
            XP: {pokemon?.base_experience}
          </div>
          <div className='font-mono font-bold text-xl top-40 py-3 px-4 mt-3 bg-white rounded-xl ml-5 opacity-75 w-52
                    lg:w-[23rem] lg:right-20 2xl:w-[7rem]  2xl:text-sm  text-center h-12'
          >
          ...
          <div className=' hidden 2xl:block font-mono font-bold text-xl top-40 py-3 px-4 mt-3 bg-white rounded-xl ml-5 opacity-75 w-52
                    lg:w-[23rem] lg:right-20 2xl:w-[7rem]   2xl:text-sm text-center h-12'
          >
      ...
      <span className=' hidden 2xl:block font-black text-[200px] fixed bottom-64 left-20 opacity-20 z-0'>{name}</span>
    </div>
  )
}
